@extends('admin.layout')
	@section('body')
		<h3 class="page-title">Edit Factory Size Management</h3>
			<!-- page layout -->
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{URL::route('admin.factorysize.edit', $factorysize->id)}}">Edit Factory Size</a>
					</li>
				</ul>
			</div>
			<div class="row">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<form  class="form-horizontal" id="addCategoryFiledForm" method="POST" action="{{URL::route('admin.factorysize.store')}}" enctype="multipart/form-data">
							    <input type="hidden" value="{{ $factorysize->id }}" name="factorysize_id" >
							    <div class="form-body">
                                     @foreach ([
                                            ...
                                            <div class="form-group" id="countryname">
                                                 <label class="col-md-3 col-sm-3 col-xs-12 control-label">{{ Form::label($key, $value) }} <span style="color:red">*</span></label>
                                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                                      {{ Form::text($key, $factorysize->factorysize, ['class' => 'form-control','placeholder'=>$value]) }}
                                                 </div>
                                            </div>
                                         @endif
                                      @endforeach
