		...
		<h3 class="page-title">Edit User Management</h3>
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{URL::route('admin.members.edit', $member->id)}}">Edit User</a>
					</li>
				</ul>
			</div>
			<div class="row">
                                            ...
                                            <div class="form-group" id="countryname">
                                                <label class="col-md-3 col-sm-3 col-xs-12 control-label">{{ Form::label($key, $value) }} <span style="color:red">*</span></label>
                                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="input-icon right">
                                                      <i class="fa"></i>
                                                        {{ Form::email($key, $member->email, ['class' => 'form-control','placeholder'=>$value]) }}
                                                    </div>
                                                 </div>
                                            </div>
                                        @elseif(($key === 'usertype'))
                                        ...
                                        @elseif( $key ==="username")
                                            <div class="form-group" id="countryname">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                   <div class="input-icon right">
                                                        <i class="fa"></i>
                                                    {{ Form::text($key, $member->username, ['class' => 'form-control','placeholder'=>$value , 'id' => 'username']) }}
                                                   </div>
                                                </div>
                                            </div>
                                         @else
                                          <div class="form-group" id="countryname">
                                             <label class="col-md-3 col-sm-3 col-xs-12 control-label">
                                              ...
                                              <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="input-icon right">
                                                	<i class="fa"></i>
                                                  {{ Form::text($key, $member->$key, ['class' => 'form-control','placeholder'=>$value]) }}
                                                </div>
                                              </div>
                                         </div>
