                                              ...
                                              <tbody>
                                               ...
                                               <?php for($i=0; $i<count($emailList); $i++){?>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          {{substr($emailList[$i]->created_at,0,10)}}
                                                      </td>
                                                      <td>
                                                           <a class="tooltips btn btn-sm rounded btn-primary" data-toggle="tooltip" data-placement="top" title="{{Lang::get('user.show')}}" href="{{URL::route('user.buyer.getEmailContent', array(100000*1+$emailList[$i]->id,$slug))}}" ><i class="fa fa-tasks"></i></a>
