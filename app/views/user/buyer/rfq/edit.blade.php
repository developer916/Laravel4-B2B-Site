                                ...
                                <fieldset>
                                 ...
                                 <fieldset>
                                    ...
                                    <?php  $i++;} ?>
                                         <div class="row extra-margin-bottom-20" id="addSpecificationDiv">
                                            <div class="col-md-4 col-md-offset-8 col-sm-4 col-sm-offset-8 col-xs-6 col-xs-offset-3">
                                                <a href="javascript:void(0)" class="btn-u btn-u-blue" onclick="addSpecificationDiv()" style="float: right">Add</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row extra-margin-bottom-20">
                                        ...
                                        <section class="col-md-4 col-sm-4 col-xs-6">
                                            <input type="text" name="target_price" class="form-control" placeholder="{{Lang::get('user.item_price')}}" value="{{$rfq->rfq_unitprice}}">
                                        </section>
                                        <section class="col-md-4 col-sm-4 col-xs-6">
     ...
     @section('custom-scripts')
            ...
            <script>
                ...
                function onSaveRFQ(obj){
                    bootbox.confirm({
                        message: "{{Lang::get('missing.do_you_want_to_edit_this_rfq')}}",
                        buttons: {
                            confirm: {
                        ...
                        callback: function (result) {
                            if (result === false) {
                                ...
                                var postUrl = '{{URL::route("user.buyer.restore")}}';
                                ...
                                fileObj.parent('form#file_upload_form').ajaxForm({
                                    success: function (data) {
                                        ...
                                        if (data.result == "failed") {
                                            ...
                                            bootbox.alert("{{Lang::get('missing.RFQ_saved_successfully')}}");
