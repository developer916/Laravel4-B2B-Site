    ...
    {{ HTML::script('/assets/assest_admin/js/spin.js') }}
        <script type="text/javascript">
            function onShowSample(id){
                 $.ajax ({
                    url: '{{ route('user.buyer.sub.sample') }}',
                    type: 'POST',
                    data: {id : id},
                    cache: false,
                    dataType : "json",
            ...
            function onShowEscrow(id){
                 $.ajax ({
                    url: ' {{ route("user.buyer.sub.escrow") }} ',
                    type: 'POST',
                    data: {id : id},
                    cache: false,
                    dataType : "json",
            ...
            function onShowOrders(id){
                     $.ajax ({
                        url: ' {{  route("user.buyer.sub.orders") }}',
                        type: 'POST',
                        data: {id : id},
                        cache: false,
                        dataType : "json",
            ...
            function onShowShipping(id){
                $.ajax ({
                    url: '{{ route("user.buyer.sub.shipping") }}',
                    type: 'POST',
                    data: {id : id},
                    cache: false,
                    dataType : "json",
            ...
            function onShowDocument(id){
                 $.ajax ({
                    url: '{{ route("user.buyer.sub.documents") }}',
                    type: 'POST',
                    data: {id : id},
                    cache: false,
                    dataType : "json",
