        ...
        <div class="col-md-offset-1 col-md-8 rightMenu col-sm-8 col-sm-offset-1">
            <div class="row">
                <div class="col-md-12 favoriteContentBody">
                    <div class="row margin-bottom-20" style="margin-top: 40px">
                    ...
                    <div class="row margin-bottom-20">
                        <div class="col-md-12">
                            <a href="{{URL::route('user.seller.loginRfq')}}"> < {{Lang::get('user.back_to_list')}}</a>
                        </div>
                    </div>
                                                                ...
                                                                <div class="row" style="margin-top: 20px">
                                                                    ...
                                                                    <div class="col-md-8 col-xs-12 col-sm-8">
                                                                         ...
                                                                         <?php if($listQuoteList[$key] == 1){?>
                                                                             <a href="{{URL::route('user.seller.editQuoteNow',(100000*1+$rfqItem->id))}}" class="btn-u btn-u-blue " data-toggle="tooltip" data-placement="top" title="{{Lang::get('user.edit_quote')}}">
                                                                                  <i class='fa fa-edit'></i>
                                                                             </a>
                                                                             <?php
                                                                                if($emailList[$key] == 1){ ?>
                                                                                    <a href="{{URL::route('user.seller.rfqEmail',(100000*1+$rfqItem->id))}}" class="tooltips btn-u btn-u-dark-blue  " data-toggle="tooltip" data-placement="top" title="{{Lang::get('user.emails')}}">
