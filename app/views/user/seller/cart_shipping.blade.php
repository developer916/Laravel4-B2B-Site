            ...
            <div class="col-md-12 orderContent margin-bottom-40" >
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 orderTitle">
                        ...
                        <form class="form-horizontal" id="addForm" action="{{URL::route('user.seller.postCartGetLabel')}}" method="post">
                            <input type="hidden" name="shoppingCart_id" value="{{100000*1+$shoppingCartProduct->id}}">
                            @if ($errors->has())
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-8">
                                    <input type="text" class="form-control" name="shipto_name" placeholder="{{Lang::get('user.name')}}" value="{{$shoppingCart->shipping_firstname." ". $shoppingCart->shipping_lastname}}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-md-4 col-sm-4 col-xs-4 control-label">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-8">
                                    <input type="text" class="form-control" name="shipto_street" placeholder="{{Lang::get('user.street_line')}}" value="{{$shoppingCart->shipping_address1." " .$shoppingCart->shipping_address2}}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-md-4 col-sm-4 col-xs-4 control-label">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-8">
                                    <input type="text" class="form-control" name="shipto_city" placeholder="{{Lang::get('user.city')}}" value="{{$shoppingCart->shipping_city}}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-md-4 col-sm-4 col-xs-4 control-label">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-8">
                                    <input type="text" class="form-control" name="shipto_state" placeholder="{{Lang::get('user.state')}}" value="{{$shoppingCart->shipping_state}}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-md-4 col-sm-4 col-xs-4 control-label">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-8">
                                    <input type="text" class="form-control" name="shipto_postalcode" placeholder="{{Lang::get('user.postal_code')}}" value="{{$shoppingCart->shipping_zip}}" readonly>
                                </div>
                            </div>
                            <div class="form-group margin-bottom-40">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-8">
                                    <select name="shipto_country" class="form-control">
                                        ...
                                        <option value="BF" <?php if(strtoupper($sellerCountry->country_name) == strtoupper('Bulgaria')) {echo "selected";} else {echo "disabled";}?>>Burkina Faso</option>
