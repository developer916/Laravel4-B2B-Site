...
@section('body')
    <div class="container content">
        <div class="title-box-v2">
            ...
            <h4>{{"(".$categoryResult->categoryname.")"}}</h4>
        </div>
                        ...
                        <div class="cbp-caption margin-bottom-20 category_image_boxshadow">
                            ...
                            <div class="cbp-caption-activeWrap">
                                ...
                                <div class="cbp-l-caption-alignCenter">
                                    <a href="{{URL::Route('user.seller.storeSubCategory', array($user_id,$userCategories[$i]->id))}}" class="cbp-l-caption-body">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="cbp-title-dark">
                            <div class="cbp-l-grid-agency-title"><?php echo $userCategories[$i]->subcategoryname;?></div>
                        </div>
                    </div>
                @endfor
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 id="myModalLabel1" class="modal-title">{{Lang::get('user.add_subcategory')}}</h4>
                </div>
                <div class="modal-body">
                    <form action="{{URL::route('user.seller.subCategoryImageUpload')}}" method="post" class="form-horizontal margin-bottom-40" enctype="multipart/form-data" id="onSaveCategoryForm">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <select class="form-control" name="category" id="category">
                                    ...
                                    @for($i=0; $i<count($category); $i++)
                                        ...
                                        @endfor
                                        @if($result != 1)
                                            <option value="{{$category[$i]->id}}">{{$category[$i]->subcategoryname}}</option>
                                        @endif
                                    @endfor
                                </select>
                            </div>
    ...
    <div class="modal fade" id="addCategoryChangeModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{URL::route('user.seller.subCategoryImageUpload')}}" method="post" class="form-horizontal margin-bottom-40" enctype="multipart/form-data" id="onSaveCategoryChangeForm">
...
@section('custom-scripts')
    ...
    <script type="text/javascript">
        ...
        function onChangeCompanyCategoryPicture(id){
            ...
            var base_url = window.location.origin;
            $.ajax ({
                url:'{{route("user.seller.subCategoryChange")}}',
                type: 'POST',
