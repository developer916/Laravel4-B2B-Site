                                              ...
                                              <tbody>
                                               ...
                                               <?php for($i=0; $i<count($emailList); $i++){?>
                                                  <tr>
                                                      ...
                                                      <td>
                                                           <a class="tooltips btn btn-sm rounded btn-primary" data-toggle="tooltip" data-placement="top" title="{{Lang::get('user.show')}}" href="{{URL::route('user.seller.newList', array(100000*1+$emailList[$i]->id,$slug))}}" ><i class="fa fa-tasks"></i></a>
